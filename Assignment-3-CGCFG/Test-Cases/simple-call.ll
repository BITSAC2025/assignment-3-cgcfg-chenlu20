...
define i32 @foo(i32 noundef %0) #0 !dbg !9 {
...
define i32 @main() #0 !dbg !18 {
  ...
  %3 = call i32 @foo(i32 noundef 1), !dbg !23
  store i32 %3, ptr %2, align 4, !dbg !22
  %4 = load i32, ptr %2, align 4, !dbg !24
  ret i32 %4, !dbg !25
}
...
!1 = !DIFile(filename: "simple-call.c", directory: "/Users/hululu/Desktop/assignment-3-cgcfg-chenlu20/Assignment-3-CGCFG/Test-Cases")
...
!9 = distinct !DISubprogram(name: "foo", scope: !1, file: !1, line: 1, type: !10, scopeLine: 1, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !13)
!10 = !DISubroutineType(types: !11)
!11 = !{!12, !12}
!12 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!13 = !{}
!14 = !DILocalVariable(name: "b", arg: 1, scope: !9, file: !1, line: 1, type: !12)
...
!25 = !DILocation(line: 7, column: 2, scope: !18)
